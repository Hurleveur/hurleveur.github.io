...
var explorer_inline_default = `var V=Object.hasOwnProperty;function y(u){let e=j(P(u,"index"),!0);return e.length===0?"/":e}function I(){return typeof document>"u"?"":document.body?.dataset?.basepath??""}function x(u,e){let t=e??I(),D=u.startsWith("/")?u:"/"+u;return t+D}function W(u,e){return u===e||u.endsWith("/"+e)}function P(u,e){return W(u,e)&&(u=u.slice(0,-e.length)),u}function j(u,e){return u.startsWith("/")&&(u=u.substring(1)),!e&&u.endsWith("/")&&(u=u.slice(0,-1)),u}var v=class u{constructor(e,t){this.children=[],this.slugSegments=e,this.data=t||null,this.isFolder=!1,this.fileSegmentHint=null,this.displayNameOverride=void 0}get displayName(){return this.displayNameOverride!==void 0?this.displayNameOverride:(this.data?.title==="index"?void 0:this.data?.title)||this.fileSegmentHint||this.slugSegment||""}set displayName(e){this.displayNameOverride=e}get slug(){let e=this.slugSegments.join("/");return this.isFolder?e+"/index":e}get slugSegment(){return this.slugSegments[this.slugSegments.length-1]||""}makeChild(e,t){let D=[...this.slugSegments,e[0]],o=new u(D,t);return this.children.push(o),o}insert(e,t){if(e.length===0)return;this.isFolder=!0;let D=e[0];if(e.length===1)D==="index"?this.data||(this.data=t):this.makeChild(e,t);else{let o=this.children.find(F=>F.slugSegment===D);o||(o=this.makeChild(e,void 0));let n=(t.filePath||t.slug||"").split("/");o.fileSegmentHint=n[n.length-e.length],o.insert(e.slice(1),t)}}add(e){this.insert(e.slug.split("/"),e)}sort(e){this.children.sort(e),this.children.forEach(t=>t.sort(e))}filter(e){this.children=this.children.filter(e),this.children.forEach(t=>t.filter(e))}map(e){e(this),this.children.forEach(t=>t.map(e))}static fromEntries(e){let t=new u([],null);return e.forEach(([,D])=>t.add(D)),t}},b=["#9b7ede","#d4a94e","#6ab7e0","#ef7b6d","#7fb069","#4ecdc4","#e0a1c9","#8fa6d4"],w={alignment:"#e05a5a",travel:"#ef8b4e",work:"#e8c14e",friends:"#7fb069",shared:"#6ab7e0",library:"#6a5acd",meaning:"#9b7ede"};function R(u){let e=u.toLowerCase();if(w[e])return w[e];let t=0;for(let D=0;D<u.length;D++)t=t*31+u.charCodeAt(D)>>>0;return b[t%b.length]}var L=["alignment","travel","work","friends","shared","library","meaning"],H=(u,e)=>{if(u.isFolder&&e.isFolder&&u.slugSegments.length===1&&e.slugSegments.length===1){let t=L.indexOf(u.slugSegment.toLowerCase()),D=L.indexOf(e.slugSegment.toLowerCase());if(t!==-1&&D!==-1)return t-D;if(t!==-1)return-1;if(D!==-1)return 1}return!u.isFolder&&!e.isFolder||u.isFolder&&e.isFolder?u.displayName.localeCompare(e.displayName,void 0,{numeric:!0,sensitivity:"base"}):!u.isFolder&&e.isFolder?1:-1},q=u=>u.slugSegment!=="tags";function _(u,e,t,D){return t&&u.filter(t),D&&u.map(D),e&&u.sort(e),u}async function $(u){try{console.log("[Explorer] Fetching content index...");let e=await fetchData;if(console.log("[Explorer] Fetched data keys:",Object.keys(e).slice(0,5)),!e)return console.error("[Explorer] No data received"),null;let t=e.content||e,D=Object.entries(t);if(console.log("[Explorer] Entry count:",D.length),D.length===0)return console.warn("[Explorer] No content entries found"),null;let o=v.fromEntries(D);console.log("[Explorer] Trie root children:",o.children.length);try{let r=await fetch(x("static/assetIndex.json"));if(r.ok)for(let C of await r.json())o.add({...C,asset:!0})}catch(r){console.warn("[Explorer] No asset index:",r)}try{let r=await fetch(x("static/categoryIndex.json"));if(r.ok)for(let[C,i]of Object.entries(await r.json()))for(let s of i){let d=s.slug.split("/").pop();o.add({...s,slug:C+"/"+d,href:s.slug})}}catch(r){console.warn("[Explorer] No category index:",r)}let n=H,F=q,f=null;if(u)try{let r=JSON.parse(u);r.sortFn&&(n=new Function("a","b","return ("+r.sortFn+")(a, b)")),r.filterFn&&(F=new Function("node","return ("+r.filterFn+")(node)")),r.mapFn&&(f=new Function("node","("+r.mapFn+")(node)"))}catch(r){console.error("Error parsing data functions:",r)}return _(o,n,F,f)}catch(e){return console.error("Error building file trie:",e),null}}var N=0;function T(u,e,t,D,o,n=""){let F=document.getElementById("template-folder"),f=document.getElementById("template-file");if(!F||!f)return;let r=n?n+"/"+u.slugSegment:u.slugSegment,C=y(t);if(u.isFolder){let i=F.content.cloneNode(!0),s=i.querySelector(".folder-container"),d=i.querySelector(".folder-button"),m=i.querySelector(".folder-title"),c=i.querySelector(".folder-outer"),a=i.querySelector(".content");if(m&&(m.textContent=u.displayName||u.slugSegment),s&&(s.dataset.folderpath=u.slug),n===""){let l=i.querySelector("li");l&&l.style.setProperty("--fc",R(u.slugSegment))}if(D==="link"&&d){let l=document.createElement("a");l.className=d.className;let g=y(u.slug);l.href=x(g||""),m?l.appendChild(m):l.textContent=u.displayName||u.slugSegment,d.replaceWith(l),d=l}let A=o[u.slug]!==void 0?o[u.slug]:!0,E=y(u.slug),B=E&&E===C.slice(0,E.length);if((!A||B)&&c&&c.classList.add("open"),u.children&&u.children.length>0&&a)for(let l of u.children)T(l,a,t,D,o,r);e.appendChild(i)}else if(u.data){let i=f.content.cloneNode(!0),s=i.querySelector("a");if(s){let d=u.data.href??u.data.slug;s.href=x(d),s.textContent=u.displayName||u.slugSegment,u.data.origin&&(s.classList.add("category-guest"),s.title="in "+u.data.origin),u.data.asset&&(s.dataset.routerIgnore=""),d===t&&s.classList.add("active","is-active")}e.appendChild(i)}}async function k(u){let e=++N;try{console.log("[Explorer] Nav event received, generation:",e);let t=(u.detail?.url||"").replace(/^\\/+/,""),D=document.querySelectorAll("div.explorer");console.log("[Explorer] Found",D.length,"explorers");let o={};try{JSON.parse(localStorage.getItem("fileTree")||"[]").forEach(F=>{o[F.path]=F.collapsed})}catch(n){console.error("[Explorer] Error loading saved state:",n)}for(let n of D){let F=n.querySelector(".explorer-ul");if(!F){console.warn("[Explorer] No explorer-ul found");continue}F.innerHTML='<li class="overflow-end"></li>';let f=n.dataset.dataFns,r=n.dataset.behavior||"collapse";console.log("[Explorer] Starting tree build...");let C=await $(f);if(e===N){if(console.log("[Explorer] Render generation is current, rendering tree"),console.log("[Explorer] Trie result:",C?"success":"null"),C&&C.children&&C.children.length>0){F.innerHTML='<li class="overflow-end"></li>',console.log("[Explorer] Rendering",C.children.length,"children");for(let a of C.children)T(a,F,t,r,o,"");console.log("[Explorer] Render complete, final list length:",F.children.length)}else console.warn("[Explorer] No trie or empty children");let c=sessionStorage.getItem("explorerScrollTop");if(c)F.scrollTop=parseInt(c,10);else{let a=F.querySelector(".active");a&&a.scrollIntoView({behavior:"smooth"})}}else console.log("[Explorer] Stale render generation, skipping tree render");let i=[],s=n.getElementsByClassName("explorer-toggle");for(let c of s){let a=function(){let A=this.closest(".explorer");if(!A)return;let E=A.classList.toggle("collapsed");A.setAttribute("aria-expanded",E?"false":"true"),E?document.documentElement.classList.remove("mobile-no-scroll"):document.documentElement.classList.add("mobile-no-scroll")};c.addEventListener("click",a),i.push(()=>c.removeEventListener("click",a))}let d=n.getElementsByClassName("folder-icon");for(let c of d){let a=function(A){A.stopPropagation();let E=this.parentElement;if(!E)return;let B=E.nextElementSibling;if(!B)return;B.classList.toggle("open");let l=!B.classList.contains("open"),g=E.dataset.folderpath,h=JSON.parse(localStorage.getItem("fileTree")||"[]"),p=h.findIndex(S=>S.path===g);p>=0?h[p].collapsed=l:h.push({path:g,collapsed:l}),localStorage.setItem("fileTree",JSON.stringify(h))};c.addEventListener("click",a),i.push(()=>c.removeEventListener("click",a))}let m=n.getElementsByClassName("folder-button");for(let c of m){let a=function(A){let E=this.closest(".folder-container");if(!E)return;let B=n.dataset.behavior||"collapse",l=E.nextElementSibling,g=E.dataset.folderpath;if(B!=="link"){if(A.stopPropagation(),!l)return;l.classList.toggle("open");let h=!l.classList.contains("open"),p=JSON.parse(localStorage.getItem("fileTree")||"[]"),S=p.findIndex(O=>O.path===g);S>=0?p[S].collapsed=h:p.push({path:g,collapsed:h}),localStorage.setItem("fileTree",JSON.stringify(p))}};c.addEventListener("click",a),i.push(()=>c.removeEventListener("click",a))}typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>i.forEach(c=>c()))}for(let n of document.getElementsByClassName("explorer")){let F=n.querySelector(".mobile-explorer");F&&(window.matchMedia("(max-width: 800px)").matches&&n.classList.add("collapsed"),F.classList.remove("hide-until-loaded"),F.checkVisibility&&F.checkVisibility()&&(n.classList.add("collapsed"),n.setAttribute("aria-expanded","false"),document.documentElement.classList.remove("mobile-no-scroll")))}}catch(t){console.error("[Explorer] Fatal error in nav handler:",t)}}document.addEventListener("nav",k);document.addEventListener("render",k);document.addEventListener("prenav",()=>{let u=document.querySelector(".explorer-ul");u&&sessionStorage.setItem("explorerScrollTop",u.scrollTop.toString())});
`;

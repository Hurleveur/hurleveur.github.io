...
var excalidraw_inline_default = `function Y(){let n=document.querySelector(".page[data-frame='excalidraw']");n&&D(n);for(let t of document.querySelectorAll(".excalidraw-view")){let l=t.querySelector(".excalidraw-canvas"),c=t.nextElementSibling,a=c?.nextElementSibling;if(!l||!c?.matches(".excalidraw-dialog"))continue;T(l);let u=Z(c.querySelector(".excalidraw-page"),l);C(t,l,c,u),a?.matches(".excalidraw-note-dialog")&&z(l,a,u)}}function T(n){let t=parseFloat(n.dataset.viewboxW)||1,l=new ResizeObserver(()=>{n.style.setProperty("--k",String(n.clientWidth/t))});l.observe(n),window.addCleanup(()=>l.disconnect())}function S(n){n.querySelector(".excalidraw-dialog-close")?.addEventListener("click",()=>n.close()),n.addEventListener("click",t=>{t.target===n&&n.close()})}function C(n,t,l,c){let a=l.querySelector(".excalidraw-container");n.querySelector(".excalidraw-expand")?.addEventListener("click",()=>{c?.reset(),a.append(t),l.showModal()}),l.addEventListener("close",()=>{c?.reset(),n.prepend(t)}),S(l)}function z(n,t,l){let c=t.querySelector(".excalidraw-note-title"),a=t.querySelector(".excalidraw-note-body");function u(r){if(l?.dragged())return;let o=r.dataset.href;c.replaceChildren();let s=o?document.createElement("a"):document.createElement("span");o&&(s.href=o),s.textContent=r.dataset.title??"",c.append(s),a.innerHTML=r.querySelector(".excalidraw-embed-content")?.innerHTML??"",t.showModal(),a.scrollTop=0}for(let r of n.querySelectorAll(".excalidraw-embed-note"))r.addEventListener("click",()=>u(r)),r.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),u(r))});S(t)}function D(n){let t=n.querySelector(".excalidraw-sidebar-toggle");t&&(t.addEventListener("click",()=>{n.classList.toggle("excalidraw-sidebar-open")}),window.addCleanup(()=>{n.classList.remove("excalidraw-sidebar-open")}))}function Z(n,t){if(!n)return;let l=()=>t.parentElement?.classList.contains("excalidraw-container"),c=1,a=0,u=0,r=0,o=null,s=null;function p(){t.style.transform="translate("+a+"px, "+u+"px) scale("+c+")"}function m(e,i,d){d=Math.max(.1,Math.min(10,d));let h=t.getBoundingClientRect(),q=(e-h.left)/c,X=(i-h.top)/c;a+=e-h.left-d*q,u+=i-h.top-d*X,c=d,p()}function y(e){let i=t.parentElement.getBoundingClientRect();m(i.left+i.width/2,i.top+i.height/2,e)}function f(e,i){r+=Math.abs(e)+Math.abs(i),a+=e,u+=i,p()}function g(e){let i=e.deltaMode===1?16:1;if(e.ctrlKey){e.preventDefault();let d=Math.max(-50,Math.min(50,e.deltaY*i));m(e.clientX,e.clientY,c*Math.exp(-d*.005))}else l()&&(e.preventDefault(),f(-e.deltaX*i,-e.deltaY*i))}function b(e){e.button===0&&(e.preventDefault(),r=0,o={x:e.clientX,y:e.clientY},t.classList.add("is-panning"))}function x(e){o&&(f(e.clientX-o.x,e.clientY-o.y),o={x:e.clientX,y:e.clientY})}function E(){o=null,t.classList.remove("is-panning")}function v(e){let[i,d]=e;return{dist:Math.hypot(i.clientX-d.clientX,i.clientY-d.clientY),x:(i.clientX+d.clientX)/2,y:(i.clientY+d.clientY)/2}}function L(e){o=null,s=null,e.length>=2?s=v(e):e.length===1&&l()&&(o={x:e[0].clientX,y:e[0].clientY})}function O(e){e.touches.length===1&&(r=0),L(e.touches)}function k(e){if(s&&e.touches.length>=2){e.preventDefault();let i=v(e.touches);f(i.x-s.x,i.y-s.y),m(i.x,i.y,c*(i.dist/s.dist)),s=i}else o&&e.touches.length===1&&(e.preventDefault(),f(e.touches[0].clientX-o.x,e.touches[0].clientY-o.y),o={x:e.touches[0].clientX,y:e.touches[0].clientY})}function M(e){L(e.touches)}function w(){r=0,c=1,a=0,u=0,p()}return n.querySelector(".excalidraw-zoom-in")?.addEventListener("click",()=>{y(c*(1+.15))}),n.querySelector(".excalidraw-zoom-out")?.addEventListener("click",()=>{y(c/(1+.15))}),n.querySelector(".excalidraw-reset")?.addEventListener("click",w),t.addEventListener("wheel",g,{passive:!1}),t.addEventListener("mousedown",b),t.addEventListener("dblclick",w),document.addEventListener("mousemove",x),document.addEventListener("mouseup",E),t.addEventListener("touchstart",O,{passive:!0}),t.addEventListener("touchmove",k,{passive:!1}),t.addEventListener("touchend",M),t.addEventListener("touchcancel",M),window.addCleanup(function(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",E)}),{reset:w,dragged:()=>r>6}}document.addEventListener("nav",Y);
`;
var l3;
function k3(n4) {
  return n4.children;

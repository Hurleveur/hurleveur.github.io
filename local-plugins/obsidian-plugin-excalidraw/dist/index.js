...
var excalidraw_inline_default = `function k(){let n=document.querySelector(".page[data-frame='excalidraw']");n&&_(n);for(let r of document.querySelectorAll(".excalidraw-view")){let t=r.querySelector(".excalidraw-canvas"),c=r.nextElementSibling,o=c?.nextElementSibling;if(!t||!c?.matches(".excalidraw-dialog"))continue;Z(t);let i=P(c.querySelector(".excalidraw-page"),t);T(r,t,c,i),o?.matches(".excalidraw-note-dialog")&&Y(t,o,i)}}function Z(n){let r=parseFloat(n.dataset.viewboxW)||1,t=new ResizeObserver(()=>{n.style.setProperty("--k",String(n.clientWidth/r))});t.observe(n),window.addCleanup(()=>t.disconnect())}function q(n){n.querySelector(".excalidraw-dialog-close")?.addEventListener("click",()=>n.close()),n.addEventListener("click",r=>{r.target===n&&n.close()})}function T(n,r,t,c){let o=t.querySelector(".excalidraw-container");n.querySelector(".excalidraw-expand")?.addEventListener("click",()=>{o.append(r),t.showModal()}),t.addEventListener("close",()=>{c?.reset(),n.prepend(r)}),q(t)}function Y(n,r,t){let c=r.querySelector(".excalidraw-note-title"),o=r.querySelector(".excalidraw-note-body");function i(a){if(t?.dragged())return;let l=a.dataset.href;c.replaceChildren();let s=l?document.createElement("a"):document.createElement("span");l&&(s.href=l),s.textContent=a.dataset.title??"",c.append(s),o.innerHTML=a.querySelector(".excalidraw-embed-content")?.innerHTML??"",r.showModal(),o.scrollTop=0}for(let a of n.querySelectorAll(".excalidraw-embed-note"))a.addEventListener("click",()=>i(a)),a.addEventListener("keydown",l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),i(a))});q(r)}function _(n){let r=n.querySelector(".excalidraw-sidebar-toggle");r&&(r.addEventListener("click",()=>{n.classList.toggle("excalidraw-sidebar-open")}),window.addCleanup(()=>{n.classList.remove("excalidraw-sidebar-open")}))}function P(n,r){let t=n?.querySelector(".excalidraw-container");if(!t)return;t.style.backgroundColor="var(--excalidraw-bg, var(--light))";let c=1,o=0,i=0,a=!1,l=0,s=0,h=0;function u(){r.style.transform="translate("+o+"px, "+i+"px) scale("+c+")"}function m(e){e.preventDefault();var d=e.deltaY>0?-.15:.15;c=Math.max(.1,Math.min(5,c+d)),u()}function M(e){e.button===0&&(a=!0,h=0,l=e.clientX-o,s=e.clientY-i,t.style.cursor="grabbing")}function w(e){a&&(h+=Math.abs(e.clientX-l-o)+Math.abs(e.clientY-s-i),o=e.clientX-l,i=e.clientY-s,u())}function E(){a=!1,t.style.cursor="grab"}var p=n.querySelector(".excalidraw-zoom-in"),x=n.querySelector(".excalidraw-zoom-out"),L=n.querySelector(".excalidraw-reset");p&&p.addEventListener("click",function(){c=Math.min(5,c+.15),u()}),x&&x.addEventListener("click",function(){c=Math.max(.1,c-.15),u()}),L&&L.addEventListener("click",b);var v=0;function O(e){if(e.touches.length===1)a=!0,h=0,l=e.touches[0].clientX-o,s=e.touches[0].clientY-i;else if(e.touches.length===2){a=!1;var d=e.touches[0].clientX-e.touches[1].clientX,f=e.touches[0].clientY-e.touches[1].clientY;v=Math.sqrt(d*d+f*f)}}function S(e){if(e.preventDefault(),e.touches.length===1&&a)h+=Math.abs(e.touches[0].clientX-l-o)+Math.abs(e.touches[0].clientY-s-i),o=e.touches[0].clientX-l,i=e.touches[0].clientY-s,u();else if(e.touches.length===2&&v>0){var d=e.touches[0].clientX-e.touches[1].clientX,f=e.touches[0].clientY-e.touches[1].clientY,g=Math.sqrt(d*d+f*f),X=g/v;c=Math.max(.1,Math.min(5,c*X)),v=g,u()}}function y(){a=!1,v=0}t.addEventListener("wheel",m,{passive:!1}),t.addEventListener("mousedown",M),document.addEventListener("mousemove",w),document.addEventListener("mouseup",E),t.addEventListener("touchstart",O,{passive:!0}),t.addEventListener("touchmove",S,{passive:!1}),t.addEventListener("touchend",y),window.addCleanup(function(){t.removeEventListener("wheel",m),t.removeEventListener("mousedown",M),document.removeEventListener("mousemove",w),document.removeEventListener("mouseup",E),t.removeEventListener("touchstart",O),t.removeEventListener("touchmove",S),t.removeEventListener("touchend",y)});function b(){h=0,c=1,o=0,i=0,u()}return{reset:b,dragged:()=>h>6}}document.addEventListener("nav",k);
`;
var l3;
function k3(n4) {
  return n4.children;

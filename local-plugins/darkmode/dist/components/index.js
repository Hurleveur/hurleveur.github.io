...
var darkmode_inline_default = 'var o=localStorage.getItem("theme")??"light";document.documentElement.setAttribute("saved-theme",o);var d=t=>{document.body?.classList.remove("theme-dark","theme-light"),document.body?.classList.add(`theme-${t}`)},c=t=>{let n=new CustomEvent("themechange",{detail:{theme:t}});document.dispatchEvent(n)},m=()=>{let t=document.documentElement.getAttribute("saved-theme")??"light";d(t);let n=()=>{let e=document.documentElement.getAttribute("saved-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("saved-theme",e),localStorage.setItem("theme",e),d(e),c(e)};for(let e of document.getElementsByClassName("darkmode"))e.addEventListener("click",n),window.addCleanup(()=>e.removeEventListener("click",n))};document.addEventListener("nav",m);document.addEventListener("render",m);\n';
